  ...
  return (
    <div className="product-card card">
      <div className="product-image">
        <Image src={product.image} alt={product.name} width={300} height={200} loading="lazy" className="product-img" />
        {discountPercentage > 0 && <div className="discount-badge">{discountPercentage}% خصم</div>}
